...
protected:
    ...
    std::vector<double> generate_solution_optimizer(bool encoded);
...
const std::vector<std::string> Optimizer::AVAILABLE_MODES = {"process", "thread", "swarm"};
const std::vector<std::string> Optimizer::SUPPORTED_ARRAYS = {"list", "tuple", "ndarray"};
